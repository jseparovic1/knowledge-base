...
- [Phpunit data provider #1](https://tighten.co/blog/tidying-up-your-phpunit-tests-with-data-providers/)
- [Using composer efficiently](https://blog.martinhujer.cz/17-tips-for-using-composer-efficiently/#tip-%2311%3A-update-dependencies-safely)
- [Hunting down memory leaks](https://www.youtube.com/watch?v=NjIlKlFImlo) (+ [presentation](https://speakerdeck.com/bitone/hunting-down-memory-leaks-with-php-meminfo))
